...
On Fedora:
    ...
    sudo dnf install -y gcc-c++ clang libcxx-devel cmake ninja-build unzip libX11-devel libXcursor-devel libXi-devel libXrandr-devel mesa-libGL-devel fontconfig-devel

On Arch:

    sudo pacman -S gcc clang cmake ninja unzip libx11 libxcursor libxi libxrandr mesa-libgl fontconfig libwebp
