...
do
  ...
  -- Indexed image + background layer +
  -- the mask color is in the palette, but it isn't defined as
  -- transparent color
  s.transparentColor = 0
  app.activeImage:clear()
  expect_img(app.activeImage,
             { 0, 0, 0,
               0, 0, 0,
               0, 0, 0 })
  ...
  -- Indexed image + background layer +
  -- the mask color is not in the palette
  p:resize(6)
  app.activeImage:clear()
  expect_img(app.activeImage,
             { 0, 0, 0,
...
do
  ...
  local p = s.palettes[1]
  local c0 = app.pixelColor.rgba(0  ,   0,   0, 255)
  local c1 = app.pixelColor.rgba(255,   0,   0, 255)
  local c2 = app.pixelColor.rgba(0  , 255,   0, 255)
  local c3 = app.pixelColor.rgba(0  ,   0, 255, 255)
  local c4 = app.pixelColor.rgba(255, 255,   0, 255)
  local c5 = app.pixelColor.rgba(255, 255, 255, 255)
  local c6 = app.pixelColor.rgba(0  ,   0,   0,   0)
  p:setColor(0, c0)
  p:setColor(1, c1)
  p:setColor(2, c2)
  p:setColor(3, c3)
...
do
  ...
  local p = s.palettes[1]
  local c0 = app.pixelColor.graya(  0, 255)
  local c1 = app.pixelColor.graya( 63, 255)
  local c2 = app.pixelColor.graya(127, 255)
  local c3 = app.pixelColor.graya(191, 255)
  local c4 = app.pixelColor.graya(255, 255)
  local c5 = app.pixelColor.graya(  0,   0)
  p:setColor(0, c0)
  p:setColor(1, c1)
  p:setColor(2, c2)
  p:setColor(3, c3)
