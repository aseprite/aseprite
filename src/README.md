...
* `F1`: Switch between raster v2 (current render engine) <-> tile-based shader renderer (possible future renderer)
* `Ctrl+F1`: Rotate between raster v1, v2, and shader renderers.
