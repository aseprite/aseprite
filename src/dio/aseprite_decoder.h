...
private:
  ...
  void readTagsChunk(doc::Tags* tags, base::fileoff_t chunk_end);
  void readSlicesChunk(doc::Slices& slices, base::fileoff_t chunk_end);
  doc::Slice* readSliceChunk(doc::Slices& slices, base::fileoff_t chunk_end);
