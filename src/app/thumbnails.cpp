...
typedef std::map< gfx::Size, SurfaceData > SurfaceMap;
...
she::Surface* ImageDir::fetch(Request& req)
{
  ...
  return m_surfaces[req.surface_size].fetch(req);
}
