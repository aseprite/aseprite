...
inline bool hidePreviewEditor(const PreviewWindow& previewWindow)
{
  ...
  if (pvWindowFrame.intersects(pvEditorFrame) && isPreviewEnabled) {
   previewEditor->setPreviewEnabled(false);
  }
  return isPreviewEnabled;
}

inline void showPreviewEditor()
{
