  ...
  if (App::instance()->context()->isUIAvailable()) {
    ...
    switch (mode) {
      case FileAccessMode::LoadLib:
        allowButtonText = Strings::script_access_allow_load_lib_access(); break;
      case FileAccessMode::OpenSocket:
        allowButtonText = Strings::script_access_allow_open_conn_access(); break;
      case FileAccessMode::Execute:
        allowButtonText = Strings::script_access_allow_execute_access(); break;
      case FileAccessMode::Write:
        allowButtonText = Strings::script_access_allow_write_access(); break;
      case FileAccessMode::Read:
        allowButtonText = Strings::script_access_allow_read_access(); break;
      default:
        return luaL_error(L, "invalid access request");
    }
