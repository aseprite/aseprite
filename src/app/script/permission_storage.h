...
public:
  ...
  std::optional<bool> get(const std::string& script, Permission permission) const;
  std::optional<bool> getMatch(const std::string& script,
                               Permission permission,
                               const std::string& match) const;
  bool getFullAccess(const std::string& script) const;

  void set(const std::string& script, Permission permission, bool value);
  void setForMatch(const std::string& script,
                   Permission permission,
                   const std::string& match,
                   bool value);
  void setFullAccess(const std::string& script, bool access);
