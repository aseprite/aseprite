...
std::string ink_type_to_string(InkType inkType)
{
  switch (inkType) {
    case tools::InkType::SIMPLE:
      return Strings::inks_simple_ink();
    case tools::InkType::ALPHA_COMPOSITING:
      return Strings::inks_alpha_compositing();
    case tools::InkType::COPY_COLOR:
      return Strings::inks_copy_color();
    case tools::InkType::LOCK_ALPHA:
      return Strings::inks_lock_alpha();
    case tools::InkType::SHADING:
      return Strings::inks_shading();
  }
  return "Unknown";
}
