...
public:
  ...
  // Returns true if the pressed keys exactly match a selection
  // modifier combination or quick copy selection modifier.
  virtual bool isSelectionModifiersPressed() = 0;
