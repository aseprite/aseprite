  ...
  : m_button(1)
{
  ...
  m_button.addItem(theme->parts.layout());
  m_button.ItemChange.connect([this](){ switchSelector(); });
  ...
  switch (animation()) {
    ...
    case ANI_COLLAPSING: {
      ...
      m_comboBox.setSizeHint(
        gfx::Size((1.0 - t) * m_startSize.w + t * m_endSize.w,
