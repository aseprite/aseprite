...
void ExportFileWindow::onOutputFilenameBrowse()
{
  ...
  ui::MenuItem relative(
    Strings::export_file_relative_path(m_outputPathBase));
...
{
  outputFilename()->setText((m_showFullPath ?
    m_outputPath + base::path_separator + m_outputFilename:
    m_outputFilename));
  onOutputFilenameEntryChange();
}
