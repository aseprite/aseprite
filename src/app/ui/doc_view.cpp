...
public:
  ...
  tools::Tool* getQuickTool(const ui::Message* msg, const tools::Tool* currentTool) override
  {
...
public:
  ...
  tools::Tool* getQuickTool(const ui::Message*, const tools::Tool*) override { return nullptr; }
